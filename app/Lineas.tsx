      ...
      <div className="grid grid-cols-2 gap-[2px]">
        ...
        <div className="bg-[#0f0f0f] border border-[#F5F0E8]/[0.04] p-16 flex flex-col justify-between min-h-[360px]">
          ...
          <div className="mt-12">
              ...
              href={`https://wa.me/${whatsapp}?text=${encodeURIComponent('Hola, quiero ver la línea Basic de CRUDO.')}`}
              target="_blank"
        ...
        <div className="bg-[#0f0f0f] border border-[#F5F0E8]/[0.04] p-16 flex flex-col justify-between min-h-[360px]">
          ...
          <div className="mt-12">
              ...
              href={`https://wa.me/${whatsapp}?text=${encodeURIComponent('Hola, quiero ver la línea Premium de CRUDO.')}`}
              target="_blank"
              rel="noopener noreferrer"
              className="text-[10px] tracking-[0.22em] uppercase text-[#F5F0E8] border-b border-[#F5F0E8]/30 pb-1 hover:border-[#F5F0E8] transition-colors"
            >
